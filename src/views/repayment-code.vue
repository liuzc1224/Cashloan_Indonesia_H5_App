        ...
        <van-row class="main">
            ...
            <div v-else>
                ...
                <van-row class="content" v-if="repaymentData">
                    ...
                    <!--                    <van-row class="code">-->
                    <!--                        <van-col span="24">-->
                    <!--                            {{$t('repaymentCode.code')}}-->
                    <!--                        </van-col>-->
                    <!--                        <van-col span="24" class="codeImage" @click="show=true">-->
                    <!--                            <van-image :src="img" class="image"></van-image>-->
                    <!--                            <p>{{$t('repaymentCode.click')}}</p>-->
                    <!--                            <van-image-preview-->
                    <!--                                    v-model="show"-->
                    <!--                                    :images="images"-->
                    <!--                                    :showIndex="false"-->
                    ...
                    <!--                    <van-row class="item">-->
                    <!--                        <van-col span="18">-->
                    <!--                            {{$t('repaymentCode.copy')}}-->
                    <!--                        </van-col>-->
                    <!--                        <van-col span="6" class="icon">-->
                    <!--                            <van-icon class="iconfont" class-prefix="my-icon" name="copy"></van-icon>-->
                    <!--                        </van-col>-->
                    <!--                    </van-row>-->
                    <!--                    <van-row class="item" @click="send">-->
                    <!--                        <van-col span="18">-->
                    <!--                            {{$t('repaymentCode.send')}}-->
                    <!--                        </van-col>-->
                    <!--                        <van-col span="6" class="icon">-->
        ...
        methods:{
            ...
            getData(){
                let data={
                    ...
                    paymentMethod:'40',
                    inAdvance:this.$route.query.inAdvance,
                    platform:1
                };
